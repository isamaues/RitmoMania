...
public class GameController : MonoBehaviour
{
    ...
    public List<int> coresSeqCompleto;
    ...
    public void InitializeIndex()
    {
        ...
        for (int j = 13; j > 0; j--)
        {
            int i = Random.Range(0, Mathf.FloorToInt(SetConfig.Instance.ButtonNumber));

            coresSeqCompleto.Add(i);
        }
    }
    ...
    IEnumerator Sequencia(int qtd)
    {
        ...
        {
            GameControllerMod2.Instance.StartMusic();
        }
        else {
